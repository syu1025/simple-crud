...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">カロリー記録 - 新規作成</h1>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden form-card">
            <div class="p-4 bg-gradient-to-r from-blue-500 to-indigo-600">
                <h2 class="text-xl font-semibold text-white">記録を追加</h2>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows="3"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none form-input"
                                placeholder="例：朝：トースト、昼：サラダ、夜：魚料理、運動：ジョギング30分"
                            ></textarea>
                            @error('note')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
